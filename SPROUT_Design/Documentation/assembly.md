...
This document provides step-by-step instructions for assembling the SPROUT compute box following enclosure preparation.

Before beginning assembly, ensure that:
- enclosure preparation is complete,
- all bonded components have fully cured,
- all hardware listed in the BOM is available.
...
<img src="Images/Assembly/qb3_positioning.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/qb3_positioning_2.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/qb3_positioning_3.jpg" width="500" class="center-img"/>

4. Install a 1/4" Push-to-Connect OD x 1/4" NPT Thread Straight Connector in the last QB3 side exhaust port.

<img src="Images/Assembly/qb3_positioning_4.jpg" width="300" class="center-img">
...
<img src="Images/Assembly/qb3_connectors_pinouts.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/qb3_connectors.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/solenoid_connector.jpg" width="500" class="center-img"/>
---
...
1. Mount the battery adapter to the external right side of the case. To do so, place the adapter flush against the top border (as shown below) and mark down the screw holes. Drill these out and isntall using appropiate fasteners. 
...
<img src="Images/Assembly/battery_adapter.jpg" width="500" class="center-img"/>

4. Once inside, crimp the wires and install a 2.8mm 2-pin male connector. See below.
<img src="Images/Assembly/battery_adapter_terminal.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/battery_adapter_2.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/battery_adapter_3.jpg" width="500" class="center-img"/>
...
9. Cut the output POWER wire (red) of each buck converter about 5" from the boards, and install and in-line fuse holder by soldering and applying heat-shrink tubing. 
...
<img src="Images/Assembly/buck_converters_connector.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/buck_converters.jpg" width="500" class="center-img"/>
...
16. Up to this point, the mount plate should look similar to the image shown below. (Note: this picture does not show the 1/8" tubing connections between exhaust ports. Make sure you have those in place. See Step 1.3)
<img src="Images/Assembly/mounting_plate.jpg" width="500" class="center-img"/>

17. Connect a 18V power supply to the lever connector and adjust all the buck converters output voltage to 15V. Disconnect power supply when done.
<img src="Images/Assembly/buck_converters_3.jpg" width="500" class="center-img"/>
---
...
1. Install wireles NIC module to Jetson. Connect the antenna cables. Mount the Jetson computer to the 3D-printed housing using appropiate fasteners. Mount assembly to plate. 

<img src="Images/Assembly/jetson.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/jetson_2.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/buck_converters_2.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/solenoid_buck_connector.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/mounting_plate_2.jpg" width="500" class="center-img"/>
...
Continue with wiring.md Section 1. Once complete, come back to do step 5.
...
<img src="Images/Assembly/receptacle.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/receptacle_connector.jpg" width="700" class="center-img"/>
...
<img src="Images/Assembly/receptacle_2.jpg" width="500" class="center-img"/>

4. Mount the receptacle to the case using appropiate fasteners.

<img src="Images/Assembly/receptacle_3.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/receptacle_4.jpg" width="500" class="center-img"/>

5. On the left side of the case (the one that is untouched at this point), drill two holes to mount the wifi antennas.

<img src="Images/Assembly/antenna_holes.jpg" width="500" class="center-img"/>

6. Print the hole pattern provided (see "Pneumatic_Holes" in XXXX), and cut it with scissors as shown below. These cuts help with alignment inside the case. Tape the cutout to the case in the inner, longer side by the hinge. 

<img src="Images/Assembly/case_holes_1.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/case_holes_2.jpg" width="500" class="center-img"/>

7. Drill the holes using 1/2" hole saws. Adjust the size of the as needed with a deburring tool so that a 1/4" Pipe Nipple can pass through it.

<img src="Images/Assembly/case_holes_3.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/exhaust_hole.jpg" width="500" class="center-img"/>

9. Once all holes have been drilled, install the mount plate in the case. Secure with fasteners. 

<img src="Images/Assembly/plate_install.jpg" width="500" class="center-img"/>

10. Install the antennas by mounting the connectors in the holes and screwing the antennas in.

<img src="Images/Assembly/antennas.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/antennas_2.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/pipes_ready.jpg" width="500" class="center-img"/>

12. Pass the pipes nipples through the holes from the outside. Screw them into the QB3 pressure regulators and solenoid following the order shown below.

<img src="Images/Assembly/pipes_connectors.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/pipes_connectors_inside.jpg" width="500" class="center-img"/>

13. Connect the one-way valve, the push-to-connect adapter, and the push-to-connect through-wall connector as shown below. 

<img src="Images/Assembly/one_way_valve_1.jpg" width="500" class="center-img"/>


14. Install the assembled adapter in the bottom hole made in step 8.

<img src="Images/Assembly/one_way_valve_2.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/one_way_valve_3.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/one_way_valve_4.jpg" width="500" class="center-img"/>
...
1. Laser cut a 18x24 3mm arcylic sheet using the provided pattern (see XXX). Rendering logo is optional.

<img src="Images/Assembly/panel.jpg" width="500" class="center-img"/>

2. Install the side handles, pheripheral connectors, push button (with cover), E-button, and LCD screen as shown. From left to right: LCD screen, HDMI connector, USB-A connector, USB-A connector, Ethernet RJ45 connector, push button with cover, E-button.

<img src="Images/Assembly/panel_2.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/power_cable.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/power_cable_2.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/power_cable_3.jpg" width="500" class="center-img"/>

5. On the other end of the sleeve, there is a free end on a red wire, and a black wire coming from the battery connector and fuse holder (see Step 2.7). Connect these to the lever connectors last empty slot (see Step 2.14)

<img src="Images/Assembly/power_cable_4.jpg" width="500" class="center-img"/>

6. Connect the cable with Dupont connectors coming from the Jetson to the LCD screen.

<img src="Images/Assembly/lcd_cable.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/panel_3.jpg" width="500" class="center-img"/>

8. Connect the Right Angle USB A to USB B male connector from the Arduino to the Jetson.

<img src="Images/Assembly/arduino_usb.jpg" width="500" class="center-img"/>

9. Connect the USB A and ethernet cables to the Jetson. Connect to DP-to-HDMI cable as well.

<img src="Images/Assembly/panel_4.jpg" width="500" class="center-img"/>

10. Rest the panel in position over the interface panel mounts. 3D-print the vents and slide them into the panel.

<img src="Images/Assembly/ventilation_1.jpg" width="500" class="center-img"/>

<img src="Images/Assembly/ventilation_2.jpg" width="500" class="center-img"/>
...
1. Pass the HDMI cable and the power cable (from Step 2.10) around the mounting plate and behing the vents, as shown below. Connect these to the screen.

<img src="Images/Assembly/screen_installation_1.jpg" width="500" class="center-img"/>

2. Using the thumb screws, mount the screen to the 3d-printed brackets. 

<img src="Images/Assembly/screen_installation_2.jpg" width="500" class="center-img"/>

3. After this, the peripherals panel can be fastened to the mounting brackets using thumb screws.

<img src="Images/Assembly/screen_installation_3.jpg" width="500" class="center-img"/>


# Step 8: Assembly with Robot Base

The base shown in these following steps was built using the [vinerobots.org](https://www.vinerobots.org/) base construction steps. A few modifications have been established, but the overall shape and functionality are identical to the one in the Vine Robots website. 
...
- As a safety precaution, 1/2" thick acrylic plates are secured with threaded rods to the sides of the base. This ensures the rubber ends do not come off due to overpressurization or faulty hose clamp installation.
- We added a shoulder strap and carrrying handles to facilitate base carrying. 

<img src="Images/Assembly/base_changes.jpg" width="500" class="center-img"/>
...
<img src="Images/Assembly/robot_base_1.jpg" width="500" class="center-img"/>

2. Sit the cylindrical robot body on top of these.

<img src="Images/Assembly/robot_base_2.jpg" width="500" class="center-img"/>

2. Then, place the compute box on top of the robot.

<img src="Images/Assembly/robot_base_3.jpg" width="500" class="center-img"/>

3. Tighten the straps to secure the compute box around the cylindrical robot body. Connect the compute box to the vine robot base using the 6-pin receptacle. Connect. Attach a battery.

<img src="Images/Assembly/robot_base_4.jpg" width="500" class="center-img"/>

4. Finally, install a vine in the reel. Connect the robot base to the pneumatic outputs. The 1/2" push-to-connect provides pressure to the main connector of the robot base; the 3-1/4" push-to-connect provide pressure to the robot body pouch motor lines. The quick-disconnect connector is the main pressurized air inlet, to be connected to a compressor or pressurized air tank.

<img src="Images/Assembly/final_assembly_2.jpg" width="500" class="center-img"/>

5.  Attach a joystick to the compute box, and the system assembly is complete!  

<img src="Images/Assembly/final_assembly.jpg" width="500" class="center-img"/>
...
- enclosure lid closes without interference.
